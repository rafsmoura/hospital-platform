...
ALTER TABLE appointments DROP CONSTRAINT appointments_patient_fk;
ALTER TABLE appointments
    ADD CONSTRAINT appointments_patient_fk FOREIGN KEY (patient_id) REFERENCES identity.users (id);
ALTER TABLE appointments DROP CONSTRAINT appointments_doctor_fk;
ALTER TABLE appointments
    ADD CONSTRAINT appointments_doctor_fk FOREIGN KEY (doctor_id) REFERENCES identity.users (id);
